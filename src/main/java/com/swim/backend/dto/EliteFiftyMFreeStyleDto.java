...
public class EliteFiftyMFreeStyleDto {
    ...
    public EliteFiftyMFreeStyleDto() {
        setAthleteId(new AthleteDto());
    }

    public EliteFiftyMFreeStyleDto(EliteFiftyMFreeStyle fiftymfreestyle) {
    ...
    public EliteFiftyMFreeStyle toModel() {
        EliteFiftyMFreeStyle model = new EliteFiftyMFreeStyle();
    ...
    public String toString() {
        return "EliteFiftyMFreeStyleDto [id=" + id + ", athleteId=" + athleteId + ", gender=" + gender + ", age=" + age
